...
function delta = nfkbOde_CpGPolyIC_SR(t,x,ode_options,v)
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
rxn_77 = p(77,1);
rxn_78 = p(78,1) * TLR3;
rxn_79 = p(79,1) * p(79,5) * ((polyIC/p(79,2)).^p(79,3))/( ((polyIC/p(79,2)).^p(79,3)) + 1 +...
    (CpG/p(79,6)).^p(88,3));
...
rxn_88 = p(88,1) * p(88,5) * ((CpG/p(88,2)).^p(88,3))/( ((CpG/p(88,2)).^p(88,3)) + 1 + ...
    ((polyIC/p(88,6)).^p(79,3)));
