...
% clear all
function [] = para_match_CpGpIC_Compet_202506_revision(data_save_file_path,input_paras,cal_codon,save_metric_name,fitting_dose)
...
if cal_codon
    ...
    save(strcat(data_save_file_path,save_metric_name),'data','metrics','collect_feature_vects','data_info');
