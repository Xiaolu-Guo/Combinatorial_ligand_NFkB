function [] = codon_save_to_ML_format_202604(data_save_file_path,data_file,codon_save_path,index_to_save)%,save_name_tag
...
writematrix(nfkb_codon_all,strcat(codon_save_path,'Comb_ligands_31conditions_X_codon_202604','.csv'));
writematrix(nfkb_id_all,strcat(codon_save_path,'Comb_ligands_31conditions_y_codon_202604','.csv'));
