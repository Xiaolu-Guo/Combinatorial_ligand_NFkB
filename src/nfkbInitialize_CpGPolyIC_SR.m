function [params, species] = nfkbInitialize_CpGPolyIC_SR()
...
% Scavenger Receptor total abundance introduced here
params(79,5) = 1;%
% Km parameter for pIC CpG compitetion
params(79,6) = 0.5;% same as params(88,2)

params(80,1) = 0.04; % NaN
params(80,2) = 0.001; % Poly(I:C) release
params(81,1) = 0.5; % NaN
params(82,1) = 0.025; % NaN
params(83,1) = 0.0007*2; % x 2 to better fit hMPDMs % Bound poly(I:C)-TLR3 degradation
%debug, remember to change back
%params(83,1) = 0.007; % Bound poly(I:C)-TLR3 degradation
...
params(88,4) = 0.001; %0.001; % NaN

% Scavenger Receptor total abundance introduced here
params(88,5) = params(79,5);%0.025 %3

% Km parameter for pIC CpG compitetion
params(88,6) = params(79,2);
