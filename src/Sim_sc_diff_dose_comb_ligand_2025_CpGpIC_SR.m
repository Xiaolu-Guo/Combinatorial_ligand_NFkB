function [] = Sim_sc_diff_dose_comb_ligand_2025_CpGpIC_SR(data_save_file_path,input_paras,cal_codon,save_metric_name)
...
% times 5 to better fit hMPDMs % Bound poly(I:C)-TLR3 degradation
p83_fold = 5;
